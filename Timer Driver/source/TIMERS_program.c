...
#include "../include/TIMERS_private.h"
#include "../include/TIMERS_interface.h"
#include "../include/TM4C123GH6PM11.h" // Device header
#include "../../COM module/include/PeriodicMode_HelpingFUnctions.h"
